...
public class FashionController 
{
    ...
    public String savedetails(@RequestBody Fashion fashion)
    {
        ...
        return "New dress collection are added";
    }
    @GetMapping("/dress")
    ...
    @GetMapping("fabric/{cloths}")
  
    public List<Fashion> showsfabric(@PathVariable String cloths)
    {
        return fashionService.findbycloths(cloths);
    }
